...
import com.example.dockertest.model.Employee;
...
public class SpringbootdockerdemoApplication {
	...
	public List<Employee> allEmployee() {
		System.out.println("From allEmployee()");
		return getAllEmplyee();
	}

	private static List<Employee> getAllEmplyee() {
		return Stream
				.of(new Employee(111, "Jiya Brein", 32, "Female", "HR", 2011, 25000.0),
						...
						new Employee(277, "Anuj Chettiar", 31, "Male", "Product Development", 2010, 35700.0))
